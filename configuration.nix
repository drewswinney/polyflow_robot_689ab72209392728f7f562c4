...
let
  ...
  password = "password";
  interface = "end0";
  hostname = "689ab72209392728f7f562c4";
in {
  nixpkgs.overlays = [
    (final: super: {
  ...
  systemd.services.git-clone = {
    ...
    script = ''
      ${pkgs.git}/bin/git clone https://github.com/drewswinney/polyflow_robot_689ab72209392728f7f562c4.git ~/home/admin
      chown -R ${user}:${user} ~/home/admin/polyflow_robot_689ab72209392728f7f562c4
    '';
  };
